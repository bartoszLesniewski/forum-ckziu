...
<head>
	...
	<script src="script-kategorie.js"></script>
</head>
...
<a class="dropdown-item active" href="lista-kategorii.php">Lista kategorii</a>
...
?>
		...
		<div class="card mx-4 my-4">
			<div class="card-header"><h3>Lista kategorii</h3></div>
			<div class="card-body">
				<div class="table-responsive col-sm-8 text-center mx-auto">
					...
					<?php
						require "connect.php";
						$sql = "SELECT id_kategorii, nazwa, dostep FROM kategorie";
						...
						if ($wynik -> num_rows > 0)
						{
							...
							{
								echo '<tr id="' . $wiersz['id_kategorii'] . '">';
								echo "<td>" . $wiersz['nazwa'] . "</td>";
								echo "<td>". $wiersz['dostep'] . "</td>";
								
								echo '<td class="pr-0 pl-0 text-center">';
								echo '<button type="button" class="btn btn-primary btn-sm ml-2 mr-2 my-1 text-center" onclick="edit(' . $wiersz['id_kategorii'] . ')"> <i class="icon-pencil"> </i>Edytuj</button>';
