...
echo<<<END
<a class="dropdown-item active" href="powiadomienia.php">Powiadomienia</a>
...
?>
	...
	<h3 class="m-4"> Powiadomienia </h3>
	<section class="container">			
			<?php
				require "connect.php";
				$sql = "SELECT login FROM uzytkownicy WHERE czy_aktywne=0 ORDER BY data_zalozenia";
				...
				if ($wynik -> num_rows > 0)
				{
					...
					{
						echo '<div class="alert alert-primary">' . "Użytkownik " . "<strong><i>" . $wiersz['login'] . "</i></strong>" . " prosi o aktywację konta. " . '<a href="prosby2.php">' . "Kliknij, aby aktywować" . "</a>" ."</div>";
					}
				}
				else
